/* Zepto 1.2.0 - zepto event ajax form ie fx touch - zeptojs.com/license */
!function (t, e) {
  ...
  var e = function () {
    ...
    function H(t, e) {
      return "number" != typeof e || h[q(t)] ? e : e + "px"
    }
    ...
    var e, n, i, r, N, P, o = [], a = o.concat, s = o.filter, u = o.slice, f = t.document, c = {}, l = {},
      ...
      w = {tr: f.createElement("tbody"), tbody: b, thead: b, tfoot: b, td: E, th: E, "*": f.createElement("div")},
    ...
    return C.matches = function (t, e) {
      ...
      var o, a, s;
      return d.test(t) && (o = i(f.createElement(RegExp.$1))), o || (t.replace && (t = t.replace(m, "<$1></$2>")), n === e && (n = p.test(t) && RegExp.$1), n in w || (n = "*"), s = w[n], s.innerHTML = "" + t, o = i.each(u.call(s.childNodes), function () {
        s.removeChild(this)
      })), R(r) && (a = i(o), i.each(r, function (t, e) {
      ...
      if ("string" == typeof t)if (t = t.trim(), "<" == t[0] && p.test(t)) r = C.fragment(t, RegExp.$1, n), t = null; else {
        ...
        if (C.isZ(t))return t;
        if (L(t)) r = z(t); else if (k(t)) r = [t], t = null; else if (p.test(t)) r = C.fragment(t.trim(), RegExp.$1, n), t = null; else {
          if (n !== e)return i(n).find(t);
          r = C.qsa(f, t)
        }
      }
      ...
      filter: function (t) {
        return A(t) ? this.not(this.not(t)) : i(s.call(this, function (e) {
        ...
        if (arguments.length < 2) {
          ...
          if (L(t)) {
            ...
            return i.each(t, function (t, e) {
              o[e] = r.style[N(e)] || a.getPropertyValue(e)
            }), o
          }
        }
        var s = "";
        if ("string" == D(t)) e || 0 === e ? s = q(t) + ":" + H(t, e) : this.each(function () {
          this.style.removeProperty(q(t))
        }); else for (n in t)t[n] || 0 === t[n] ? s += q(n) + ":" + H(n, t[n]) + ";" : this.each(function () {
      ...
      toggleClass: function (t, n) {
        return t ? this.each(function (r) {
          var o = i(this), a = J(this, t, r, G(this));
      ...
      i.fn[t] = function (r) {
        var o, a = this[0];
        return r === e ? $(a) ? a["inner" + n] : F(a) ? a.documentElement["scroll" + n] : (o = this.offset()) && o[t] : this.each(function (e) {
          a = i(this), a.css(t, J(this, r, e, a[t]()))
        })
      }
      ...
      i.fn[n] = function () {
        ...
        return a.length < 1 ? this : this.each(function (e, n) {
          ...
          var c = i.contains(f.documentElement, s);
  ...
  return t.Zepto = e, void 0 === t.$ && (t.$ = e), function (e) {
    ...
    function j(t) {
      ...
      for (e in t)w.test(e) || t[e] === i || (n[e] = t[e]);
      return S(n, t)
    }
    ...
    var b = function () {
      ...
      return !1
    }, w = /^([A-Z]|returnValue$|layer[XY]$|webkitMovement[XY]$)/, T = {
      ...
      return t && !a(t) ? (e.each(t, function (t, e) {
        ...
        f && (c = function (t) {
          ...
          return a && a !== o ? (i = e.extend(j(t), {
            currentTarget: a,
            liveFired: o
          }), (c || u).apply(a, [i].concat(r.call(arguments, 1)))) : void 0
        }), y(o, t, u, s, n, l || c)
      }))
    ...
    function P(t, n, i, r) {
      ...
      e.each(n, function (n, u) {
        o = e.type(u), r && (n = i ? r : r + "[" + (s || "object" == o || "array" == o ? n : "") + "]"), !r && a ? t.add(u.name, u.value) : "array" == o || !i && "object" == o ? P(t, u, i, n) : t.add(n, u)
      })
    }
    ...
    h.href = t.location.href, e.active = 0, e.ajaxJSONP = function (r, o) {
      ...
      var c, p, a = r.jsonpCallback, s = (e.isFunction(a) ? a() : a) || "Zepto" + n++, u = i.createElement("script"),
        f = t[s], l = function (t) {
          e(u).triggerHandler("error", t || "abort")
        }, h = {abort: l};
      return o && o.promise(h), e(u).on("load error", function (n, i) {
        clearTimeout(p), e(u).off().remove(), "error" != n.type && c ? y(c[0], h, r, o) : x(null, i || "error", h, r, o), t[s] = f, c && e.isFunction(f) && f(c[0]), f = c = void 0
      ...
      m(a), a.crossDomain || (u = i.createElement("a"), u.href = a.url, u.href = u.href, a.crossDomain = h.protocol + "//" + h.host != u.protocol + "//" + u.host), a.url || (a.url = t.location.toString()), (f = a.url.indexOf("#")) > -1 && (a.url = a.url.slice(0, f)), j(a);
      var c = a.dataType, p = /\?.+=\?/.test(a.url);
      if (p && (c = "jsonp"), a.cache !== !1 && (n && n.cache === !0 || "script" != c && "jsonp" != c) || (a.url = S(a.url, "_=" + Date.now())), "jsonp" == c)return p || (a.url = S(a.url, a.jsonp ? a.jsonp + "=?" : a.jsonp === !1 ? "" : "callback=?")), e.ajaxJSONP(a, s);
      var O, d = a.accepts[c], g = {}, b = function (t, e) {
        g[t.toLowerCase()] = [t, e]
      }, C = /^([\w-]+:)\/\//.test(a.url) ? RegExp.$1 : t.location.protocol, N = a.xhr(), P = N.setRequestHeader;
      ...
      if (N.setRequestHeader = b, N.onreadystatechange = function () {
          if (4 == N.readyState) {
            N.onreadystatechange = w, clearTimeout(O);
            var t, n = !1;
            if (N.status >= 200 && N.status < 300 || 304 == N.status || 0 == N.status && "file:" == C) {
              if (c = c || T(a.mimeType || N.getResponseHeader("content-type")), "arraybuffer" == N.responseType || "blob" == N.responseType) t = N.response; else {
                t = N.responseText;
                try {
      ...
      if (N.open(a.type, a.url, M, a.username, a.password), a.xhrFields)for (o in a.xhrFields)N[o] = a.xhrFields[o];
      for (o in g)P.apply(N, g[o]);
      return a.timeout > 0 && (O = setTimeout(function () {
        N.onreadystatechange = w, N.abort(), x(null, "timeout", N, a, s)
      ...
      var s, r = this, o = t.split(/\s/), u = C(t, n, i), f = u.success;
      return o.length > 1 && (u.url = o[0], s = o[1]), u.success = function (t) {
        r.html(s ? e("<div>").html(t.replace(a, "")).find(s) : t), f && f.apply(r, arguments)
      }, e.ajax(u), this
    };
    ...
    var i, s, u, f, c, l, h, p, d, m, n = "", r = {Webkit: "webkit", Moz: "", O: "o"},
      o = document.createElement("div"),
      a = /^((translate|rotate|scale)(X|Y|Z|3d)?|matrix(3d)?|perspective|skew(X|Y)?)$/i, g = {};
    o.style.transform === e && t.each(r, function (t, r) {
      ...
      var x, E, S, b = {}, w = "", T = this, j = t.fx.transitionEnd, C = !1;
      if (i === e && (i = t.fx.speeds._default / 1e3), y === e && (y = 0), t.fx.off && (i = 0), "string" == typeof n) b[h] = n, b[p] = i + "s", b[m] = y + "s", b[d] = r || "linear", j = t.fx.animationEnd; else {
        E = [];
        for (x in n)a.test(x) ? w += x + "(" + n[x] + ") " : (b[x] = n[x], E.push(v(x)));
        w && (b[s] = w, E.push(s)), i > 0 && "object" == typeof n && (b[u] = E.join(", "), b[f] = i + "s", b[l] = y + "s", b[c] = r || "linear")
      }
      return S = function (e) {
    ...
    function m() {
      a = null, n.last && (n.el.trigger("longTap"), n = {})
    }
    ...
    function E(E) {
      var w, T, C, N, S = 0, j = 0;
      b(), h = E && "down" in E ? E : "ontouchstart" in document ? {
        down: "touchstart",
        up: "touchend",
        move: "touchmove",
        cancel: "touchcancel"
        ...
        (!(N = x(t, "down")) || y(t)) && (C = N ? t : t.touches[0], t.touches && 1 === t.touches.length && n.x2 && (n.x2 = void 0, n.y2 = void 0), w = Date.now(), T = w - (n.last || w), n.el = e("tagName" in C.target ? C.target : C.target.parentNode), i && clearTimeout(i), n.x1 = C.pageX, n.y1 = C.pageY, T > 0 && 250 >= T && (n.isDoubleTap = !0), n.last = w, a = setTimeout(m, s), u && N && u.addPointer(t.pointerId))
      }, l = function (t) {
        (!(N = x(t, "move")) || y(t)) && (C = N ? t : t.touches[0], g(), n.x2 = C.pageX, n.y2 = C.pageY, S += Math.abs(n.x1 - n.x2), j += Math.abs(n.y1 - n.y2))
      }, c = function (t) {
        (!(N = x(t, "up")) || y(t)) && (g(), n.x2 && Math.abs(n.x1 - n.x2) > 30 || n.y2 && Math.abs(n.y1 - n.y2) > 30 ? o = setTimeout(function () {
    ...
    var i, r, o, a, u, f, c, l, h, n = {}, s = 750, p = !1;
    ["swipe", "swipeLeft", "swipeRight", "swipeUp", "swipeDown", "doubleTap", "tap", "singleTap", "longTap"].forEach(function (t) {
      e.fn[t] = function (e) {
        return this.on(t, e)
      }
    }), e.touch = {setup: E}, e(document).ready(E)
  }(e), e
});